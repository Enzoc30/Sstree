...
inline bool isInside(const Point& center, NType radius, const Point& point) {
    return distance(center, point) <= radius;
}


inline std::pair<Point, NType> findSmallestEnclosingBall(const std::vector<Point>& points) {
